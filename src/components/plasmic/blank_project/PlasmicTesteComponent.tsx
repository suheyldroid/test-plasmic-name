...
// Plasmic Project: pMHw3d1Nh3z5moXDFVw2Jr
// Component: vliVEvWY2hX
...
import projectcss from "./plasmic_blank_project.module.css"; // plasmic-import: pMHw3d1Nh3z5moXDFVw2Jr/projectcss
import sty from "./PlasmicTesteComponent.module.css"; // plasmic-import: vliVEvWY2hX/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: DSySKJUOOup/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: fHYAxM-w9LL/icon

export type PlasmicTesteComponent__VariantMembers = {
...
export type PlasmicTesteComponent__VariantsArgs = {
...
type VariantPropType = keyof PlasmicTesteComponent__VariantsArgs;
export const PlasmicTesteComponent__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicTesteComponent__ArgsType = {
...
type ArgPropType = keyof PlasmicTesteComponent__ArgsType;
export const PlasmicTesteComponent__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicTesteComponent__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultTesteComponentProps extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
function PlasmicTesteComponent__RenderFunc(props: {
  variants: PlasmicTesteComponent__VariantsArgs;
  args: PlasmicTesteComponent__ArgsType;
  overrides: PlasmicTesteComponent__OverridesType;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__sCaEb)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tMKh3)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicTesteComponent>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicTesteComponent__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicTesteComponent__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicTesteComponent__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTesteComponent__ArgProps,
          internalVariantPropNames: PlasmicTesteComponent__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicTesteComponent__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTesteComponent";
  } else {
    func.displayName = `PlasmicTesteComponent.${nodeName}`;
  }
  return func;
}

export const PlasmicTesteComponent = Object.assign(
  // Top-level PlasmicTesteComponent renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTesteComponent
    internalVariantProps: PlasmicTesteComponent__VariantProps,
    internalArgProps: PlasmicTesteComponent__ArgProps,

    useBehavior
  }
);

export default PlasmicTesteComponent;
/* prettier-ignore-end */
